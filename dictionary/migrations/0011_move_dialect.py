...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        tas = orm.Dialect(name="Tasmania")
        tas.save()
        vic = orm.Dialect(name="Victoria")
        vic.save()
        wa =  orm.Dialect(name="Western Australia")
        wa.save()
        sa =  orm.Dialect(name="South Australia")
        sa.save()
        qld = orm.Dialect(name="Queensland")
        qld.save()
        nsw = orm.Dialect(name="New South Wales")
        nsw.save()
        nth = orm.Dialect(name="Northern Dialect")
        nth.save()
