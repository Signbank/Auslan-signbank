...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        fields = {'religiontf': 'religion',
                  'catholictf': 'catholic', 
                  'cathschtf':  '"catholic school"', 
                  'angcongtf':  'anglican', 
                  'jwtf':       '"jehovas witness"', 
                  'otherreltf': '"other religion"', 
                  ...
                  'animalstf': 'animal',
                  'arithmetictf': 'arithmetic',
                  'artstf': 'arts',
                  'bodyloctf': 'body locating',
                  'bodyprtstf': 'bodypart',
                  'carstf': 'car',
                  'citiestf': 'city',
                  'clothingtf': 'clothing',
