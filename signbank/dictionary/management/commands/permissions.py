...
view_unpublished_defs = Permission.objects.get(codename='can_view_unpub_defs', content_type__model__exact='gloss')
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
            ...
            publisher.permissions.add(view_unpublished_defs)
