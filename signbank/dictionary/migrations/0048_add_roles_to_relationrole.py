...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        variant = orm.Relationrole(role='variant',
                                   forwardmessage='Has Variant',
                                   backwardmessage='Is Variant Of')
        variant.save()
        antonym = orm.Relationrole(role='antonym',
                                   forwardmessage='Antonym',
                                   backwardmessage='Antonym')
        antonym.save()
        synonym = orm.Relationrole(role='synonym',
                                   forwardmessage='Synonym',
                                   backwardmessage='Synonym')
        synonym.save()
        seealso = orm.Relationrole(role='seealso',
                                   forwardmessage='See Also',
                                   backwardmessage='See Also')
        seealso.save()
        homophone = orm.Relationrole(role='homophone',
                                   forwardmessage='Homophone',
                                   backwardmessage='Homophone')
        homophone.save()

    def backwards(self, orm):
        orm.Relationrole.objects.all().delete()
    ...
    models = {
        ...
        u'dictionary.gloss': {
            ...
            'regional_template': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
        ...
        u'dictionary.relationrole': {
            'Meta': {'object_name': 'Relationrole'},
            'backwardmessage': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'forwardmessage': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
