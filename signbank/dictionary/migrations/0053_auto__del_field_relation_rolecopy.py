...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Relation.rolecopy'
        db.delete_column(u'dictionary_relation', 'rolecopy')


    def backwards(self, orm):
        # Adding field 'Relation.rolecopy'
        db.add_column(u'dictionary_relation', 'rolecopy',
