...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.frequency'
        db.alter_column(u'dictionary_region', 'frequency', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Region.frequency'
        db.alter_column(u'dictionary_region', 'frequency', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'dictionary.gloss': {
            ...
            'regional_template': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
