...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Relationrole'
        db.create_table(u'dictionary_relationrole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('forwardmessage', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('backwardmessage', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'dictionary', ['Relationrole'])

    def backwards(self, orm):
        # Deleting model 'Relationrole'
        db.delete_table(u'dictionary_relationrole')
