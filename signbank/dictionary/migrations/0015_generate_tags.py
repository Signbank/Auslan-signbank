...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        fields = {'religiontf': 'religion',
                  ...
                  'opaquetf': 'opaque',
                  'ordertf': 'order',
                  'orienttf': 'orientating sign',
                  'peopletf': 'people',
                  'physicalactstf': 'physical act',
                  'propernametf': 'proper name',
                  'qualitytf': 'quality',
                  'quantitytf': 'quantity',
                  'para': 'parallel',
                  'questsigntf': 'question',
                  'recreationtf': 'recreation',
                  'reglextf': 'regional',
                  'restricttf': 'restricted lexeme',
                  'roomstf': 'rooms',
                  'saluttf': 'salutation',
                  'sensestf': 'sensing',
                  'seonlytf': 'signed english only',
                  'setf': 'signed english',
                  'sextf': 'sexuality',
                  'shapestf': 'shapes',
                  'shoppingtf': 'shopping',
                  ...
                  'sym': 'symmetrical',
                  'techtf': 'technical',
                  'telecomtf': 'telecommunications',
                  'timetf': 'time',
                  'transltf': 'translucent',
                  'transptf': 'transparent',
                  'traveltf': 'travel',
                  'utensilstf': 'utensil',
                  'varlextf': 'varlex',
                  'weathertf': 'weather',
