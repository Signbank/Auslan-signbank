...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Region'
        db.create_table(u'dictionary_region', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gloss', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.Gloss'])),
            ('dialect', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dictionary.Dialect'])),
            ('frequency', self.gf('django.db.models.fields.IntegerField')()),
            ('traditional', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'dictionary', ['Region'])


    def backwards(self, orm):
        # Deleting model 'Region'
        db.delete_table(u'dictionary_region')
