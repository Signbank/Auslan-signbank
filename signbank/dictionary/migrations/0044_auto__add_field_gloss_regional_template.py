...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.regional_template'
        db.add_column(u'dictionary_gloss', 'regional_template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gloss.regional_template'
        db.delete_column(u'dictionary_gloss', 'regional_template')
